...
{
    public class WonkyBlade : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("This seems wonky.");  //The (English) text shown below your weapon's name
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.crit = 20; // The critical strike chance the weapon has. The player, by default, has 4 critical strike chance
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<WonkyBlade>(), 10);
            // You can use recipe.AddIngredient(ItemID.TheItemYouWantToUse, the amount of items needed); for a vanilla item.
            recipe.AddTile(ItemID.WorkBench); // Set the crafting tile to ExampleWorkbench
        ...
        public override void OnHitNPC(Player player, NPC target, int damage, float knockback, bool crit)
        {
            ...
            target.AddBuff(ModContent.BuffType<Unstable>(), 3600);
            player.AddBuff(BuffID.Wisp, 300);
        }
